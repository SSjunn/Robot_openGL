...
#include <GL/glut.h>
#include <stdlib.h>
#include "stb_image.h" //이미지 로드를 위한 헤더
...
void head()
{
	...
	gluQuadricTexture(h, GL_TRUE); // 머리 텍스처 활성화
...
void myinit()
{
	...
	// 텍스처 로드
	loadTexture("C:\\Users\\tjtjd\\Desktop\\3-2\\OpenGL\\Final_Project\\Robot\\Project1\\Textures\\face.bmp", &headTextureID);
